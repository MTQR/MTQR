...
int main()
{
	...
	std::cout << std::left 
            << std::setw(11) << ""
            << std::setw(11) << "r_min = " + std::to_string(r_min) + ".\n";
  std::cout << std::left 
            << std::setw(11) << ""
            << std::setw(11) << "r_max = " + std::to_string(r_max) + ".\n";
  std::cout << std::left 
            << std::setw(11) << ""
	...
	export_results(lambda_min, lambda_max, n_min, beta_min, beta_max, transf_order, plot);

	std::cout << "Output data available in the 'NQL/monomial_transf/output/n=" << n_min << "' subdirectoy.\n\nProgram terminated!\n" << std::endl;
...
void export_results(const double& lambda_min, const double& lambda_max, const int& n_min, const double& beta_min, const double& beta_max, const double& r, const std::string& plot_flag)
{
	...
	std::string results_file = output_dir + std::to_string(n_min) + "/Results.txt";
