double lambda_max = 73.0/3.0;                               // 24.333333333333332
double lambda_min = boost::math::constants::pi<double>()/2; // 1.5707963267948966
...
std::cout << std::left
          << std::setw(14) << ""
          << std::setw(14) << "## Executing example driver: test2 ##"
          << "\n";
std::cout << std::left
          << std::setw(14) << ""
          << std::setw(14) << driver_line
