double lambda_max = (boost::math::constants::e<double>() + 0.25); // 2.9682818284590451
double lambda_min = (-boost::math::constants::pi<double>()/4);    // -0.78539816339744828
...
std::cout << std::left
          << std::setw(14) << ""
          << std::setw(14) << "## Executing example driver: test1 ##"
          << "\n";
std::cout << std::left
          << std::setw(14) << ""
          << std::setw(14) << driver_line
