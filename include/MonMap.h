...
// (SEE LINES 171~187 IN 'src/MonMap.cpp') Computes the new nodes and weights of the monomial transformation quadrature rule
...
// (SEE LINES 290~309 IN 'src/MonMap.cpp') Computes the numerical integral for a given quadrature rule
