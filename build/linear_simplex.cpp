...
// clear && rm outputs.txt && g++ -w linear_simplex.cpp -o linear_simplex -I../include -L. -lmtqr -lm -lquadmath -lgsl -lgslcblas && ./linear_simplex
...
int main(int argc, char* argv[]){
	...
	std::vector<double> integral = {0.001851851851851851851851852, // basis function n°1
									0.250000000000000000000000000, // basis function n°2
									0.250000000000000000000000000, // basis function n°3
									0.01507936507936507936507937,  // basis function n°4
									0.01150793650793650793650794,  // basis function n°5
									0.2083333333333333333333334};  // basis function n°6
	...
	for(int b=0; b<integral.size()-1; b++){
